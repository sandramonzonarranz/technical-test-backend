...
public class WalletService {
    ...
    @Transactional
    public void topUp(UUID walletId, BigDecimal amount, String creditCardNumber) {
        if (!walletRepository.existsById(walletId)) {
            throw new WalletNotFoundException();
        }
        eventPublisher.publishEvent(new TopUpRequestedEvent(walletId, creditCardNumber, amount));
    }
